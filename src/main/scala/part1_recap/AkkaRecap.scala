...
object AkkaRecap extends App {
  ...
  val system = ActorSystem("AkkaRecap")// actor encapsulation
  val actor = system.actorOf(Props[SimpleActor], "simpleActor") // #1: you can only instantiate an actor through the actor system
  actor ! "hello"// #2: sending messages
  ...
  actor ! PoisonPill// stopping actors - context.stop
  // logging
  // supervision
